...
function proformaOlustur() {
  ...
  const proformaHTML = `
    ...
    <body>
     ...
     <p><strong>Euro Kuru: ${euroKuru} </strong> - <strong>KDV: ${kdvDurumu}</strong></p>


        <p class="footer">
        <strong>CHIMICOS</strong> - İletişim/Other Community : chimicos.com / chimicos.tr
            ...
            <p class="footer">
             Ürün teslimat adresi: Rifat Hakan Güleser SP.  dir.  
            <p class="footer">
Banka Bilgileri:
Rifat Hakan Güleser
